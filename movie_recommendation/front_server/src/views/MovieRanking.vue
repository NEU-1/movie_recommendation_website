<template>
  <div class="container">
    <img :src="require(`../assets/펭구2.png`)" alt="Side image" class="side-image left-image">
    <img :src="require(`../assets/펭구1.png`)" alt="Side image" class="side-image right-image">
    <nav class="genre-nav">
      <ul class="no-bullet">
        <h1><b>MV.GG RANKING</b></h1><BR/>
        <li class="genre-item" v-for="genre in genres" :key="genre.pk" @click="filterByGenre(genre.pk)" 
    ...
    <li class="movie-item" v-for="(movie, index) in sortedMovies" :key="movie.id">
      <img :src="require(`../assets/challenger.png`)" alt="Movie image" class="movie-img">
